    ...
    elemHead.innerHTML = `
            ...
            <div class="header-buttons">
                ...
                <button class="items-added">
                    ...
                    <div class="items-added-text"> 0 Items Added</div>

                </button>
                <button class="login">
                    <div class="login-img"> <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                    ...
                    <div class="login-text"> Login or Sign Up </div>
                </button>
            </div>
        </div>
